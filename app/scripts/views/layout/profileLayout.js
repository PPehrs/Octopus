...
function( Backbone, Chart, ProfilelayoutTmpl  ) {
    'use strict';
	...
	return Backbone.Marionette.LayoutView.extend({
		...
		onShow: function() {
			...
			var formChart = new Chart(ctx).Line(data, {bezierCurve: false});
			//formChart.update();

			var ctx2 = this.ui.matchesChart.get(0).getContext("2d");
			var formChart = new Chart(ctx2).Bar(data, {barShowStroke: false});
		}
	});
